...
def Read_Board():
	current_board = cv2.imread('images/boardwO_Color.png') # frame of board taken after each move
	img = current_board
	...
	img_subtract = cv2.subtract(template,current_board)
	cv2.imshow('Subtracted',img_subtract)
