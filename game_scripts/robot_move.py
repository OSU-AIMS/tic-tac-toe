...
def prepare_path_tf_ready():
	...
	""" 
	tf = transformations()
	centers =[[-centerDist ,centerDist,pieceHeight],[0,centerDist,pieceHeight],[centerDist,centerDist,pieceHeight],
						[-centerDist,0,pieceHeight],[0,0,pieceHeight],[centerDist,0,pieceHeight],
						[-centerDist,-centerDist,pieceHeight],[0,-centerDist,pieceHeight],[centerDist,-centerDist,pieceHeight]]
