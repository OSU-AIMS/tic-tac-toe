...
# When you run rosrun pick-and-place bag_to_csv.py it will check the directory you are currently in for bag files
# Run the command in the directory where bag files are located to convert them to csv
# Converts all topics in bag file to csv file :)
